...
const ContactNewForm = ({handleSubmit, error, ...props}) => (
    ...
    <form onSubmit={handleSubmit}>
        ...
        <div>
            <b>Name:</b>
            <Field name={'fullName'}
                   component={Input} placeholder={'add data'}
                   validate={[required]}/>
        ...
        <div>
            ...
            <b>github:</b> <Field name={'github'}
                                  component={Input} placeholder={'github'}
                                  validate={[required]}/>
            {/*{props.users.github}*/}
        </div>
        <div>
            <b>VK:</b> <Field name={'vk'}
                              component={Input} placeholder={'VK'}
                              validate={[required]}/>
            {/*{props.users.vk}*/}
        </div>
        <div>
            <b>Facebook:</b> <Field name={'facebook'}
                                    component={Input} placeholder={'facebook'}
                                    validate={[required]}/>
            {/*{props.users.facebook}*/}
        </div>
        <div>
            <b>Instagram: </b> <Field name={'instagram'}
                                      component={Input} placeholder={'instagram'}
                                      validate={[required]}/>
            {/*{props.users.instagram}*/}
        </div>
        <div>
            <b>Twitter: </b> <Field name={'twitter'}
                                    component={Input} placeholder={'twitter'}
                                    validate={[required]}/>
            {/*{props.users.twitter}*/}
        </div>
        {/*</div>*/}
