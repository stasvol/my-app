...
const SetPage = ({countUsersSet, pageSizeSet,currentPageSet,onCurPageSet,pagesPart=10,}) => {
 ...
 const {pagesPartCount,pageNumber,setPageNumber,maxPageNumber,handleClick,activePagesSet} =
     useSetPagePaginator(countUsersSet,pageSizeSet,pagesPart,onCurPageSet,currentPageSet)
