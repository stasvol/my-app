...
const SetContainer = ({
  ...
  // //     settingApi.setGetPage
  // (this.props.pageSizeSet,this.props.currentPageSet)
  // //         .then(response => {
  // //
  ...
  // .samuraijs.com/api/1.0/Profile/2`).then(response => {
  // //     //
  ...
  // // //             {
  // // //     id: 1, photoUrl: "https://i.pinimg.com/originals/53/08/1c/
  // 53081c48b54b7be2805a0b2ad5470735.jpg",
  // // //                 followed: true, name: 'Andre', status: "I'm  Cool"
  // // //             },
  // // //             {
  // // //    id: 2, photoUrl: "https://i.pinimg.com/originals/b4/
  // 98/f9/b498f91f653cd9ed231209b12fac64c7.jpg",
  ...
  //     })
  // }
  const { onCurPageSet } = useSettingUsersContainer(
    setIsLoad,
    pageSizeSet,
    currentPageSet,
    settingAddUser,
  ...
  // render() {
  //
  //        const countPagesSet = Math.ceil((this.props.countUsersSet /
  //        this.props.pageSizeSet )/100)
  //
  //        const pagesSet =[];
  //
  ...
  //             {
  //                 pagesSet.map((p,i) =>{
  //     return  <span onClick={(e)=>{this.onCurPageSet(p)}} key={i}
  //     className={ this.props.currentPageSet === p
  //                         ?  classes.active
  //                         : classes.pag}>{p}</span>
  //                 })
  //             }
...
const mapStateToProps = ({
  users: { users, countUsersSet, pageSizeSet, currentPageSet, isLoad },
  setAuth: { isSetAuth },
}) => {
  return {
    users,
...
SetContainer.propTypes = {
  ...
  settingAddUser: PropTypes.func.isRequired,
  settingUserTotalCount: PropTypes.func.isRequired,
