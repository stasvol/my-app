...
import './App.css';
// const DialogContainer = React
// .lazy(() => import("./Components/Dialogs/DialogContainer"));
// const ProfileContainer = React
// .lazy(() => import("./Components/Profile/ProfileContainer"));
// const UserContainer = React
// .lazy(() => import("./Components/Users/UserContainer"));
    ...
    return (
      <>
        ...
        <img
          alt=""
          className="images"
          src="https://cdn.segodnya.ua/img/gallery/5975/59/615213_main.jpg"
        />
      </>
    );
  }
